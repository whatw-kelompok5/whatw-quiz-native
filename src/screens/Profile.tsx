      ...
      <View style={{ flex: 1, position: 'relative' }}>
        ...
        <View
          ...
          <View width={'100%'} height={'70%'}>
            <View backgroundColor="white" width={'100%'}   height={'60%'} borderRadius="$2xl" padding="$4" alignItems="center" marginBottom="$2">
            ...
            <View
              ...
              paddingTop={'$1'}
              alignItems="center">
              <Input size="md" borderWidth={0} isDisabled={false} isInvalid={false} isReadOnly={false}>
