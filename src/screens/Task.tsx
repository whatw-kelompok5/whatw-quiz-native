      ...
      <View style={{ flex: 1, position: 'relative' }}>
        ...
        <View display="flex" flexDirection="row" justifyContent="space-between" alignItems="center" width="100%" paddingHorizontal={30}>
          ...
          <View backgroundColor="white" width={'100%'} height={600} borderTopLeftRadius="$2xl" borderTopRightRadius="$2xl" alignItems="center">
            ...
            {showScore ? (
              <View display="flex" flexDirection="column" alignItems="center" justifyContent="center" marginTop={50} height={300}>
                <Text>Congrats, you got</Text>
                <Text color="black" fontSize={20} fontWeight="bold" marginTop={10} marginBottom={60}>
                  {score}
                </Text>
              ...
              <View display="flex" flexDirection="column" alignItems="center" justifyContent="center" height={'100%'} marginTop={-40}>
                <Text>question :</Text>
